...
local xrandr = require('configuration.keys.xrandr')
-- Key bindings
local globalKeys =
  ...
  awful.key({modkey, 'Control'}, 'j', function () awful.screen.focus_relative(1) end, {description = 'screen next', group = 'screen'}),
  awful.key({modkey, 'Control'}, 'k', function () awful.screen.focus_relative(-1) end, {description = 'screen prev', group = 'screen'}),
  ...
  awful.key(
    ...
    'h',
    function()
      awful.spawn('/usr/bin/variety -p')
    end,
    {description = 'Prev Wallpaper', group = 'Wallpaper'}
  ),
  awful.key(
    {modkey},
    'h',
    function()
      awful.spawn('/usr/bin/variety -n')
    end,
    {description = 'Next Wallpaper', group = 'Wallpaper'}
  ),
  awful.key(
    {modkey},
    's',
    function()
      awful.spawn('rofi -terminal alacritty -show ssh -modi ssh')
    end,
  ...
  awful.key(
    ...
    'r',
    function()
      awful.spawn('rofi -terminal alacritty -combi-modi window,drun -show combi -modi combi,ssh')
    end,
    {description = 'Main menu', group = 'awesome'}
  ),
  awful.key(
  ...
  awful.key(
    ...
    'p',
    function()
      awful.util.spawn_with_shell('rofi -modi 1pass:rofi-1pass -show 1pass')
    end,
    {description = 'Show 1password passwords', group = 'screenshots (clipboard)'}
  ),
  -- awful.key(
    -- {modkey},
    -- 'p',
  ...
  awful.key(
    ...
    'm',
    function()
      awful.client.setslave(awful.client.focus)
    end,
    {description = 'Demote Window', group = 'layout'}
  ),
  awful.key(
    {modkey, 'Shift'},
    'm',
    function()
      awful.client.setmaster(awful.client.focus)
    end,
    {description = 'Promote Window', group = 'layout'}
  ),
  awful.key(
    {altkey, 'Shift'},
    'Down',
