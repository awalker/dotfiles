...
-- local Volume = require('widget.volume.volume-slider')
...
local TopPanel = function(s)
    ...
    panel:setup {
      ...
      nil,
      {
        ...
        -- wibox.container.margin(Bluetooth, dpi(3), dpi(3), dpi(6), dpi(3)),
        -- wibox.container.margin(Volume, dpi(3), dpi(3), dpi(6), dpi(3)),
        wibox.container.margin(Battery, dpi(3), dpi(3), dpi(6), dpi(3)),
        -- Layout box
        LayoutBox(s),
        -- Clock
        clock_widget,
