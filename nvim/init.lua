...
require('lazy').setup({
  -- I used to love fugitive, these days I mostly use lazygit, leaving these in because I might switch back
  -- Git related plugins
  'tpope/vim-fugitive',
  'tpope/vim-rhubarb',
  ...
  -- TODO: Decide on a different theme?
  -- {
  ...
  --   end,
  -- },
  -- THEME: duskfox or nordfox variants? of nightfox.
  {
    -- Theme inspired by Atom
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'ocaml', 'sql' },
